...
@Component({
  ...
  styleUrls: ['./../../assetsp/css/style.css', './../../assetsp/css/animate.css'
  ,'./../../assetsp/css/bootstrap.min.css','./../../assetsp/css/line-awesome.css',
  './../../assetsp/css/responsive.css',' ../../../../assetsp/lib/slick/slick-theme.css',' ../../../../assetsp/lib/slick/slick.css',
  './../../assetsp/css/line-awesome-font-awesome.min.css','./../../assetsp/css/font-awesome.min.css']
})
...
async onSubmit() {
  ...
  if (value) {
    ...
    if (!value.body && !value.image ) {
      Swal.fire({
        title: 'Error',
        text: 'Please enter a body or select an image',
        icon: 'error'
      });
      return;
    }
